...
while True:
    ...
    switchIcon = pygame.image.load("/Users/sammyliu/desktop/brush.png")
    ...
    delcolorIcon = pygame.image.load("/Users/sammyliu/desktop/brush.png")
    ...
    if event.type == QUIT:
        ...
        if (delcolorIconPosX - 4 < pygame.mouse.get_pos()[0] < delcolorIconPosX - 4 + delcolorIconWidth and
            delcolorIconPosY - 4 < pygame.mouse.get_pos()[1] < delcolorIconPosY - 4 + delcolorIconHeight):
            pygame.draw.rect(screen, (0, 0, 0), [350, 440, 80, 80], 0)
            xiaoxiaole.tool_3()
